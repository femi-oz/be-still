                    ...
                    children: <Widget>[
                      custom.ExpansionTile(
                          ...
                          title: Row(
                            children: <Widget>[
                              SizedBox(width: 3),
                              Text('Group Info', style: AppTextStyles.boldText16),
                              SizedBox(width: 10),
                              Expanded(
                                child: Divider(
                          ...
                          ? Column(
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Text('Invite', style: AppTextStyles.boldText16),
                                      SizedBox(width: 10),
                                      Expanded(
                                        child: Divider(
                                          color: AppColors.darkBlue,
                      ...
                      (isAdmin || isModerator)
                          ? custom.ExpansionTile(
                              ...
                              title: Padding(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text('Members | ${data.groupUsers.length}', style: AppTextStyles.boldText16),
                                    SizedBox(width: 10),
                                    Expanded(
                                      child: Divider(
                                        color: AppColors.lightBlue1,
                                          ...
                                          child: Container(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: <Widget>[
                                                  Text(user.fullName?.toUpperCase() ?? 'N/A', style: AppTextStyles.regularText15),
                                                  Text(
                                                    isAdmin
                                                        ? 'ADMIN'
                                                        : isModerator
                                                            ? 'MODERATOR'
                                                            : 'MEMBER',
                                                    style: AppTextStyles.regularText15.copyWith(color: AppColors.lightBlue1),
                                                  ),
                                                ],
                                              ),
                                            ),
