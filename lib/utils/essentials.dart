...
class AppColors {
  ...
  static const Color red = const Color(0xFFFF3B30);

  static const Color offWhite5 = const Color(0xFFEDF0F2);

  static const Color grey = const Color(0xFF8D9CAE);
  static const Color blueGrey = const Color(0xFFB7CCE7);
